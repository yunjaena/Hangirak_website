...
<form action="./SignUpSave.php" method ="post" style="border:1px solid #ccc">
  <div class="container">
    ...
    <input type="text" placeholder="Enter Sex(Male:M,Female:Y)" name="sex" required>

    <label for="allergy"><b>Allergy</b></label>
    <input type="text" placeholder="Enter allergy Info" name="allergy" required>

    <label for="name"><b>Name</b></label>
    <input type="text" placeholder="Enter Name" name="name" required>

    <label for="post_num"><b>Post Number</b></label>
    <input type="password" placeholder="Enter post_num" name="post_num" required>
